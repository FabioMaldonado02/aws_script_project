...
user_instances_type="type_placeholder"  
user_key_name="key_name" 
user_security_group_ids="Security_group_placeholder"   
user_region="region_placeholder"
...
EOL
    ...
    #SSH into EC2 Instance"
     ...
     #So, it will be easy to automate by entering 2
      ssh -i key_file_placeholder kali@$aws_machine_ip
      ;;
    3)
